...
from apps.guard.models import Persona
# forms
from apps.guard.content import UsuarioModelForm
...
class CrearUsuario(JsonGenericView, CreateView):
    ...
    template_name = 'guard/usuarios/content_crear_usuario.html'
...
class ActualizarUsuario(JsonGenericView, UpdateView):
    ...
    model = User
    form_class = UsuarioModelForm
    template_name = 'guard/usuarios/content_actualizar_usuario.html'