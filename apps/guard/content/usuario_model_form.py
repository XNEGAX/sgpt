...
class UsuarioModelForm(forms.ModelForm):
    username = forms.CharField(required=True, error_messages={'required': 'Ingrese el username'},label='Username',widget=forms.TextInput(attrs={'class':'form-control','id':'username','tabindex':'0'}))
    ...
    class Meta:
        model = User
        fields = ['username',
        # 'prr_razon_social','ncn','gic','prr_nombre_fantasia','prr_observacion','bnc','prr_numero_cuenta','t_tcb','prr_dv'
        ]
