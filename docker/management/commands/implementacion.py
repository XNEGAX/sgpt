...
class Command(MigrateCommand):
    def handle(self, *args, **options):
        ...
        try:
            ...
            --actividades
            INSERT INTO public.actividad(id, nombre, descripcion, ind_base, orden, fecha, actividad_padre_id, responsable_id, seccion_id, tipo_entrada_id)VALUES(106, 'DIAGRAMA PROCESO MEJORADO.', 'BPMN', false, 4, '2023-03-04 01:05:58.663', 31, 2, 1, 2);
            INSERT INTO public.actividad(id, nombre, descripcion, ind_base, orden, fecha, actividad_padre_id, responsable_id, seccion_id, tipo_entrada_id)VALUES(105, 'EVALUACIÓN DE HERRAMIENTAS DE DESARROLLO E IMPLEMENTACIÓN', '', false, 2, '2023-03-04 01:04:09.950', 31, 2, 1, 2);
            ...
            INSERT INTO public.actividad(id, nombre, descripcion, ind_base, orden, fecha, actividad_padre_id, responsable_id, seccion_id, tipo_entrada_id)VALUES(54, 'MODELO ENTIDAD RELACIÓN O MODELO DE DATOS DEPENDE DEL PROYECTO', '', false, 2, '2023-02-28 19:50:18.882', 48, 2, 1, 2);
            INSERT INTO public.actividad(id, nombre, descripcion, ind_base, orden, fecha, actividad_padre_id, responsable_id, seccion_id, tipo_entrada_id)VALUES(53, 'CONSTRUCCIÓN DE PROTOTIPO FUNCIONAL', '', false, 7, '2023-02-28 19:49:27.219', NULL, 2, 1, 2);
            INSERT INTO public.actividad(id, nombre, descripcion, ind_base, orden, fecha, actividad_padre_id, responsable_id, seccion_id, tipo_entrada_id)VALUES(52, 'DIAGRAMA DE COMPONENTES', '', false, 3, '2023-02-28 19:45:51.424', 49, 2, 1, 2);
            ...
            INSERT INTO public.actividad(id, nombre, descripcion, ind_base, orden, fecha, actividad_padre_id, responsable_id, seccion_id, tipo_entrada_id)VALUES(50, 'DIAGRAMA CASOS DE USOS', 'DEBE SER INCLUSIÓN O EXTENSIÓN', false, 1, '2023-02-28 19:44:47.063', 49, 2, 1, 2);
            ...
            INSERT INTO public.actividad(id, nombre, descripcion, ind_base, orden, fecha, actividad_padre_id, responsable_id, seccion_id, tipo_entrada_id)VALUES(47, 'ESPECIFICACIÓN DE REQUERIMIENTO', '', false, 6, '2023-02-28 19:42:59.092', 41, 2, 1, 1);
            ...
            INSERT INTO public.actividad(id, nombre, descripcion, ind_base, orden, fecha, actividad_padre_id, responsable_id, seccion_id, tipo_entrada_id)VALUES(40, 'CARTA GANTT', '', false, 4, '2023-02-28 19:38:59.153', 36, 2, 1, 2);
            ...
            INSERT INTO public.actividad(id, nombre, descripcion, ind_base, orden, fecha, actividad_padre_id, responsable_id, seccion_id, tipo_entrada_id)VALUES(37, 'COMPARATIVA DE METODOLOGÍAS ASOCIADAS AL PROYECTO', '', false, 1, '2023-02-28 19:37:22.909', 36, 2, 1, 1);
            ...
            INSERT INTO public.actividad(id, nombre, descripcion, ind_base, orden, fecha, actividad_padre_id, responsable_id, seccion_id, tipo_entrada_id)VALUES(34, 'DIAGRAMA DE ARQUITECTURA DE SOLUCIÓN PROPUESTA', '', false, 3, '2023-02-28 19:35:41.260', 31, 2, 1, 2);
            ...
            INSERT INTO public.actividad(id, nombre, descripcion, ind_base, orden, fecha, actividad_padre_id, responsable_id, seccion_id, tipo_entrada_id)VALUES(29, 'RIESGOS DE IMPLEMENTACIÓN', '', false, 4, '2023-02-28 19:32:38.428', 25, 2, 1, 1);
            INSERT INTO public.actividad(id, nombre, descripcion, ind_base, orden, fecha, actividad_padre_id, responsable_id, seccion_id, tipo_entrada_id)VALUES(28, 'RIESGOS DEL CLIENTE', '', false, 3, '2023-02-28 19:32:06.483', 25, 2, 1, 1);
            INSERT INTO public.actividad(id, nombre, descripcion, ind_base, orden, fecha, actividad_padre_id, responsable_id, seccion_id, tipo_entrada_id)VALUES(27, 'RIESGOS DE DESARROLLO', '', false, 2, '2023-02-28 19:31:46.313', 25, 2, 1, 1);
            INSERT INTO public.actividad(id, nombre, descripcion, ind_base, orden, fecha, actividad_padre_id, responsable_id, seccion_id, tipo_entrada_id)VALUES(26, 'RIESGOS DE PLANEACIÓN', '', false, 1, '2023-02-28 19:31:14.897', 25, 2, 1, 1);
            ...
            INSERT INTO public.actividad(id, nombre, descripcion, ind_base, orden, fecha, actividad_padre_id, responsable_id, seccion_id, tipo_entrada_id)VALUES(22, 'ANÁLISIS COSTO BENEFICIO A UN AÑO', '', false, 2, '2023-02-28 19:29:19.778', 20, 2, 1, 1);
            ...
            INSERT INTO public.actividad(id, nombre, descripcion, ind_base, orden, fecha, actividad_padre_id, responsable_id, seccion_id, tipo_entrada_id)VALUES(8, 'DESCRIPCIÓN DEL PROCESO A INTERVENIR (BPMN)', '', false, 4, '2023-02-28 19:22:13.332', 4, 2, 1, 1);
            ...
            INSERT INTO public.actividad(id, nombre, descripcion, ind_base, orden, fecha, actividad_padre_id, responsable_id, seccion_id, tipo_entrada_id)VALUES(6, 'ORGANIGRAMA', '', false, 2, '2023-02-28 19:21:13.501', 4, 2, 1, 2);
            ...
            INSERT INTO public.actividad(id, nombre, descripcion, ind_base, orden, fecha, actividad_padre_id, responsable_id, seccion_id, tipo_entrada_id)VALUES(3, 'ANEXOS', '', true, 99, '2023-02-28 19:54:57.634', NULL, 2, 1, NULL);
